...
function Home() {
let {products,add}=useContext(usercontext)
//console.log(total)
/*let products=[
{
  "id": 1,
...
},
{
  ...
  return (
    <>
    <div className='container text-center mt-4 fw-bolder'>Shop Your Products</div>
      ...
      <div>
          <div className="card m-3 text-center " style={{ width: '18rem' }}>
              ...
              <div className="card-body">
                  ...
                  <button className='btn btn-light'onClick={()=>add(product)}> Add to Cart</button>
